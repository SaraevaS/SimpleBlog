	...
	if (isset($_SESSION['username']) and $_SESSION['username'] == 'admin' and $_SESSION['password']=='12345' ) {
		...
		<div class="add">
			...
			<form action="" method="post" style="background-color: sandybrown">
				...
				<input type="submit" name="submit" value="post" class="post"> <br> <br><br>
				<input type="submit" name="back" value="back" class="post" style="">
			</form>
		</div>
		</body>
		<?php
			...
			if(isset($_POST['submit'])){
			    ...
			    if($title==null || $content==null || $kind==null){
			    	...
			    	$sql = "INSERT INTO data(title, type, content, data)
			    	VALUES('$title', '$kind', '$content', '$date')";
